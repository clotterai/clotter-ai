...
export function PageHeader({
  ...
  return (
    <header className="relative shrink-0 border-b border-white/[0.06] bg-[#030303]/75 px-8 py-6 backdrop-blur-2xl sm:px-10">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-[#6366F1]/30 to-transparent"
      />
      <div className="flex items-center justify-between gap-6">
        <div>
          <p className="dash-label">{label}</p>
          <h1 className="dash-title-page mt-2 sm:text-[2.25rem]">{title}</h1>
        </div>
