...
function ChatPageContent() {
  ...
  return (
    <div className="relative flex h-[calc(100dvh-3.5rem)] min-h-0 flex-col overflow-hidden md:h-screen">
      ...
      <header className="relative z-10 shrink-0 overflow-hidden border-b border-[#7C3AED]/10 bg-[#05050f]/40 px-4 py-2 backdrop-blur-xl md:px-8 md:py-4 sm:px-10">
        <div
          aria-hidden
        ...
        <div className="flex items-center justify-between gap-3 md:gap-6">
          ...
          <span className="hidden shrink-0 rounded-full border border-[#A855F7]/50 bg-gradient-to-r from-[#7C3AED] to-[#A855F7] px-3 py-1 text-[10px] font-semibold tracking-[-0.01em] text-white shadow-[0_0_24px_-6px_#A855F7] md:inline-flex md:px-4 md:py-2 md:text-xs sm:px-5 sm:text-sm">
            ⚡ Clotter Lite
          </span>
        </div>
      </header>
